...
public interface MovimientoRepository extends JpaRepository<MovimientoModel, Long> {
	...
	List<MovimientoModel> findByFechaBetweenAndCuentaModel_ClienteModel(LocalDate fechaInicio, LocalDate fechaFin,
			ClienteModel cliente);

	List<MovimientoModel> findByFechaBetweenAndCuentaModel_ClienteModel_NumDoc(LocalDateTime fechaInicio,
			LocalDateTime fechaFin, String numDoc);
