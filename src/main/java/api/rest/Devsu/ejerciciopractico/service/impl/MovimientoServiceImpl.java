...
public class MovimientoServiceImpl implements MovimientoService{
	...
	public MovimientoModel createMovimiento(MovimientoDTO movimiento) {
		...
		if(!movimientoModel.getTipMov().equalsIgnoreCase("Deposito") && cuentaModel.getSaldoInit()<movimientoModel.getValor()) {
			throw new ServiceException("Saldo no Disponible.");
		}
		
		movimientoModel.setSaldoDisponible(cuentaModel.getSaldoInit());				
		cuentaModel.setSaldoInit(movimientoModel.getTipMov().equalsIgnoreCase("Deposito")? movimientoModel.getSaldoDisponible() + movimientoModel.getValor(): movimientoModel.getSaldoDisponible() - movimientoModel.getValor() );
	...
	private List<MovimientoDTO> mapToMovimientoDTO(List<MovimientoModel> movimientosModel) {
		...
		for (MovimientoModel movimientoModel : movimientosModel) {
			...
			movimientoModel.getCuentaModel().setSaldoInit(movimientoModel.getTipMov().equalsIgnoreCase("Deposito")? movimientoModel.getCuentaModel().getSaldoInit()-movimientoModel.getValor():movimientoModel.getCuentaModel().getSaldoInit()+movimientoModel.getValor());
